async def getProductServingSizeAndNutritionDetails(pageReference: any, specificProductInfo):
    print("----------> Getting the product serving size ...")
    try:
        ...
        print("----------> Product serving size component not found in the page")
        productServingSize = "unknown"
       
    if productServingSize != None:
        print("----------> Serving size stored")
    ...
    print("----------> Getting the product nutrition details ...")
    try:
        ...
        print("----------> Component for nutrition score was not found in the page")
    ...
    try:
        ...
        print("-----------> Component for fats not found in the page")
    ...
    try:
        ...
        print("-----------> Component for fats and acids not found in the page")
    ...
    try:
        ...
        print("-----------> Component for salt not found in the page")
    ...
    print("----------> Product nutrition details stored")
